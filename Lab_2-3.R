rm(list=ls())
data_cust2 <- read.csv("data_cust_2-2.csv", header=TRUE)
...
write.csv(cust_train, "data_cust_2-3_train.csv", row.names = FALSE)
write.csv(cust_test, "data_cust_2-3_test.csv", row.names = FALSE)
