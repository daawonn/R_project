...
#작업 디렉토리 설정
#setwd("C:/R_Project/Hanwha/Workplace")
setwd("C:/Users/admin/Desktop/Doit_R/file/hanhwa.data")
...
data_claim <- read.csv("BGCON_CLAIM_DATA.csv", header=TRUE, sep=",", encoding="CP949", fileEncoding="UCS-2")

data_cntt <- read.csv("BGCON_CNTT_DATA.csv", header=TRUE, sep=",", encoding="CP949", fileEncoding="UCS-2")

data_fmly <- read.csv("BGCON_FMLY_DATA.csv", header=TRUE, sep=",", encoding="CP949", fileEncoding="UCS-2")

data_fpinfo <- read.csv("BGCON_FPINFO_DATA.csv", header=TRUE, sep=",", encoding="CP949", fileEncoding="UCS-2")
